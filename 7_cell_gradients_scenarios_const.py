...
for index in top_models:
    ...
    book.save("../output/"+output_folder+"/"+str(index)+"_scenario_pm.xlsx")
    book = load_workbook("../output/"+output_folder+"/"+str(index)+"_scenario_pm.xlsx")
    writer = pd.ExcelWriter("../output/"+output_folder+"/"+str(index)+"_scenario_pm.xlsx", engine='openpyxl')
    writer.book = book
    ...
    fig.savefig("../output/" + output_folder + "/plots/"+str(index)+"_marginal_avg_sensitivity.png", bbox_inches='tight')
    '''
    ...
    with open("../output/" + output_folder + "/"+str(index)+"_gradients_by_cell.pkl", "wb") as f:
    ...
    with open("../output/"+output_folder+"/"+str(index)+"_results.pkl", "wb") as f:
    ...
    gradients.to_csv("../output/"+output_folder+"/"+str(index)+"_gradients.csv", index=False)
    gradients_masked.to_csv("../output/"+output_folder+"/"+str(index)+"_gradients_masked.csv", index=False)
